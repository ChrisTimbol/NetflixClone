/* List of pages scraped */
 const requests = {
    ...
    Drama: `https://api.themoviedb.org/3/search/movie?api_key=${process.env.NEXT_PUBLIC_TMDB_API_KEY}&language=en-US&query=reality&page=1&include_adult=false`,
